System.config({
  ...
  bundles: {
    "app-build": [
      ...
      "BuybackVehicleSearch.html!github:systemjs/plugin-text@0.0.2",
      "BuybackManagement.html!github:systemjs/plugin-text@0.0.2",
      "app.html!github:systemjs/plugin-text@0.0.2",
      "viewModels/BuybackVehicleViewModel",
      "viewModels/BuybackResultViewModel",
      "utilities/Mapper",
      ...
      "models/Dealer",
      "models/BuybackVehicleQuery",
      "models/BuybackResult"
    ],
    "aurelia": [
