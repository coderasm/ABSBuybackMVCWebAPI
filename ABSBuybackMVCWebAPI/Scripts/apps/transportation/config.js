System.config({
  ...
  paths: {
    "*": "Scripts/apps/transportation/dist/*",
    "github:*": "Scripts/apps/transportation/jspm_packages/github/*",
    "npm:*": "Scripts/apps/transportation/jspm_packages/npm/*"
  },

  map: {
    "aurelia-animator-css": "npm:aurelia-animator-css@1.0.0-beta.1.0.1",
    "aurelia-bootstrapper": "npm:aurelia-bootstrapper@1.0.0-beta.1",
    "aurelia-computed": "github:jdanyow/aurelia-computed@0.9.1",
    ...
    "github:jdanyow/aurelia-computed@0.9.1": {
